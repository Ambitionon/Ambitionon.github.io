...
const DOMAIN_NAME = 'kq2codeing.com.cn' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'springboot', link: '/pages/117708e0af7f0bd9/' },
    ...
    repo: 'Ambitionon', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'Ambitionon', // 必需
      link: 'https://github.com/Ambitionon/', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Ambitionon | kq', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'java后端博客,个人技术博客,后端,后端开发,前端框架,java后端,后端面试题,技术文档,学习,面试,Java,数据库，spring,redis,springcloud',
      },
    ],
